...
export const toastSlice = createSlice({
  ...
  reducers: {
    ...
    setToastPlacement: (state, action: PayloadAction<ToastProviderProps['placement']>) => {
      state.placement = action.payload
    },

    // Update the maximum number of visible toasts
    setMaxVisibleToasts: (state, action: PayloadAction<ToastProviderProps['maxVisibleToasts']>) => {
    ...
    setToastOffset: (state, action: PayloadAction<ToastProviderProps['toastOffset']>) => {
      state.toastOffset = action.payload
    },

    // Update the toast variant (solid, bordered, flat)
    setVariant: (state, action: PayloadAction<ToastProviderProps['variant']>) => {
      state.variant = action.payload
    },

    // Update the toast timeout duration
    setTimeout: (state, action: PayloadAction<ToastProviderProps['timeout']>) => {
      state.timeout = action.payload
    },

    // Show or hide the toast icon
    setHideIcon: (state, action: PayloadAction<ToastProviderProps['hideIcon']>) => {
      state.hideIcon = action.payload
    },

    // Show or hide the close button
    setHideCloseButton: (state, action: PayloadAction<ToastProviderProps['hideCloseButton']>) => {
    ...
    setSeverity: (state, action: PayloadAction<ToastProviderProps['severity']>) => {
      state.severity = action.payload
    },

    // Bulk update any combination of toast config options
    updateToastConfig: (state, action: PayloadAction<Partial<ToastProviderProps>>) => {
