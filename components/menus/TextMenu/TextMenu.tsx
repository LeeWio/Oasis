  ...
  return (
    ...
    >
      ...
      >
        ...
        <MemoButton icon="lucide:bold" isSelected={states.isBold} value="Bold" onClick={commands.onBold} />
        <MemoButton icon="lucide:italic" isSelected={states.isItalic} value="Italic" onClick={commands.onItalic} />
        <MemoButton
        ...
        />
        <MemoButton icon="lucide:code" isSelected={states.isCode} value="Code" onClick={commands.onCode} />
